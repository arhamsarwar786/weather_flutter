...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: selectedWeather == null ? Center(child: SizedBox(
          height: 100,
          width: 100,
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/images/${imageSelector(selectedWeather!.weather![0].main)}"),fit: BoxFit.cover)
        ),
        child: Column(children: [
          
         CustomImage(size: size.height /2,url: "",),
         CustomText(text: "${selectedWeather!.name}",fontSize: 40,),
         date == null ?CircularProgressIndicator.adaptive():  CustomText(text: date),
         
        CustomText(text: "${tempConverter(selectedWeather!.main!.temp)}°C",fontSize: 50,fontWeight: FontWeight.bold,)
